                            ...
                            $output .= '<div class="row coming-soon-footer">';
                                ...
                                $output .= '<div class="col-md-12 text-center margin-five no-margin-bottom footer-social">';
                                    if( $hcode_coming_soon_notify_me_fb == 1 ):
                                        $output .= '<a href="'.esc_url( $hcode_coming_soon_notify_me_fb_url ).'" target="_blank" class="black-text-link"><i class="fa fa-facebook"></i></a>';
                                    endif;
                                    if( $hcode_coming_soon_notify_me_tw == 1 ):
                                        $output .= '<a href="'.esc_url( $hcode_coming_soon_notify_me_tw_url ).'" target="_blank" class="black-text-link"><i class="fa fa-twitter"></i></a>';
                                    endif;
                                    if( $hcode_coming_soon_notify_me_gp == 1 ):
                                        $output .= '<a href="'.esc_url( $hcode_coming_soon_notify_me_gp_url ).'" target="_blank" class="black-text-link"><i class="fa fa-google-plus"></i></a>';
                                    endif;
                                    if( $hcode_coming_soon_notify_me_dr == 1 ):
                                        $output .= '<a href="'.esc_url( $hcode_coming_soon_notify_me_dr_url ).'" target="_blank" class="black-text-link"><i class="fa fa-dribbble"></i></a>';
                                    endif;
                                    if( $hcode_coming_soon_notify_me_yt == 1 ):
                                        $output .= '<a href="'.esc_url( $hcode_coming_soon_notify_me_yt_url ).'" target="_blank" class="black-text-link"><i class="fa fa-youtube"></i></a>';
                                    endif;
                                    if( $hcode_coming_soon_notify_me_li == 1 ):
                                        $output .= '<a href="'.esc_url( $hcode_coming_soon_notify_me_li_url ).'" target="_blank" class="black-text-link"><i class="fa fa-linkedin"></i></a>';
                                    endif;
                                    if( $hcode_coming_soon_notify_me_in == 1 ):
                                        $output .= '<a href="'.esc_url( $hcode_coming_soon_notify_me_in_url ).'" target="_blank" class="black-text-link"><i class="fa fa-instagram"></i></a>';
                                    endif;
                                    if( $hcode_coming_soon_notify_me_pi == 1 ):
                                        $output .= '<a href="'.esc_url( $hcode_coming_soon_notify_me_pi_url ).'" target="_blank" class="black-text-link"><i class="fa fa-pinterest-p"></i></a>';
                                    endif;
                                    if( $hcode_coming_soon_notify_me_gh == 1 ):
                                        $output .= '<a href="'.esc_url( $hcode_coming_soon_notify_me_gh_url ).'" target="_blank" class="black-text-link"><i class="fa fa-github"></i></a>';
                                    endif;
                                    if( $hcode_coming_soon_notify_me_ws == 1 ):
                                        $output .= '<a href="'.esc_url( $hcode_coming_soon_notify_me_ws_url ).'" target="_blank" class="black-text-link"><i class="fa fa-external-link"></i></a>';
                                    endif;
