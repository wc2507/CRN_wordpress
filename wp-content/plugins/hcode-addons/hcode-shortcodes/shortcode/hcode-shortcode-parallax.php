            ...
            switch ($hcode_parallax_style) {
                case 'parallax':
                    $output .='<div '.$id.' class="parallax-portfolio" '.$class.$parallax.' >';
                        $output .='<a href="'.$link.'" class="text-uppercase"><div class="opacity-light bg-slider"></div></a>';
                        $output .='<figure>';
                            ...
                            if($hcode_show_button && $first_button_title):
                                $output .='<div class="look-project wow fadeInUp"><a href="'.$link.'" class="text-uppercase">+ '.$first_button_title.'</a></div>';
                            endif;
                        $output .='</figure>';
                    $output .='</div>';
                break;
                        ...
                        $output .='<div class="portfolio-short-description-bg pull-left" '.$parallax.'>';
                            $output .='<figure class="pull-right '.$hcode_animation_style.'">';
                                ...
                                if($hcode_seperater == '1'){
                                    ...
                                    if($title):
                                        $output .='<h3 class="white-text">'.$title.'</h3>';
                                    endif;
                                    $output .= '<p class="light-gray-text margin-seven">'.$show_excerpt.'</p>';
                                    if($hcode_show_button && $first_button_title):
                                        $output .='<a href="'.$link.'" class="btn-small-white-background btn margin-ten no-margin-bottom">'.$first_button_title.'</a>';
                                    endif;
                                $output .='</figcaption>';
                            $output .='</figure>';
                        $output .='</div>';
