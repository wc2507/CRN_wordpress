	...
	function hcode_row_inner( $atts, $content = null ){
		...
		if(empty($hcode_row_style)){
			...
			if(!empty($hcode_row_section_class) || !empty($position_relative) || !empty($overflow_hidden) || !empty($hcode_relative_projects) || !empty($padding) || !empty($fullscreen) || !empty($equal_height) || !empty($content_placement) || !empty($extra_class_inner_row) ){
				$hcode_row_section_class_att  .= 'class="'.$css_class.$hcode_row_section_class.$equal_height.$content_placement.$fullscreen.$position_relative.$overflow_hidden.$hcode_relative_projects.$scroll_to_down.$scroll_to_down_class.$padding.$extra_class_inner_row.'"';
			}
			...
			switch ($hcode_row_style) {
				case 'color':
					...
					$output .= '<div'.$id.' class="'.$css_class.$class.$equal_height.$content_placement.$fullscreen.$hcode_row_padding_class.$hcode_row_mobile_padding.$hcode_row_animation_style_att.$position_relative.$overflow_hidden.$scroll_to_down.$scroll_to_down_class.$margin.$padding.$extra_class_inner_row.'" '.$hcode_row_section_style.$scroll_to_down_onclick.'>';
