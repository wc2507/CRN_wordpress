    	...
    	switch ($hcode_font_icon_type) {
    		case 'hcode_font_awesome_icons':
                if( $hcode_font_awesome_custom_icon == 1 && !empty( $hcode_font_awesome_custom_icon_image ) ) {
                    $output .= '<img src="'.wp_get_attachment_url( $hcode_font_awesome_custom_icon_image ).'" alt="" class="icon-image '.$icon_common_class.$show_border.$hcode_icon_box_size.$show_border_rounded.$hcode_icon_box_decoration.$hcode_icon_box_background.'" />';
                } else {
    		...
    		case 'hcode_et_line_icons':
                if( $hcode_et_line_custom_icon == 1 && !empty( $hcode_et_line_custom_icon_image ) ) {
                    $output .= '<img src="'.wp_get_attachment_url( $hcode_et_line_custom_icon_image ).'" alt="" class="icon-image '.$icon_common_class.$hcode_et_icon_box_size.$et_show_border.$show_et_border_rounded.$et_plain.$circled.$hcode_et_icon_box_decoration.$hcode_et_icon_box_background_color.'" />';
                } else {
