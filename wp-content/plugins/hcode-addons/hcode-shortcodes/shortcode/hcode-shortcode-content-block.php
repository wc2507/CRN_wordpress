    	...
    	switch ($hcode_block_premade_style) {
    		case 'block-1':
                ...
                if( $hcode_block_telephone == 1 ):
                	$output .= '<p class="black-text no-margin-bottom"><strong>T.</strong> <a href="tel:'.$hcode_block_telephone_number.'">'.$hcode_block_telephone_number.'</a></p>';
            	endif;
            ...
            case 'block-13':
                $output .= '<div class="testimonial-style2'.$class.'"'.$id.'>';
                    if( $custom_icon == 1 && !empty( $custom_icon_image ) ) :
                          $output .= '<img src="'.wp_get_attachment_url( $custom_icon_image ).'" alt="" class="icon-image '.$hcode_block_icon_size.'" />';
                ...
                $output .= '<div class="about-couple '.$class.'" '.$id.'>';
                    $output .= '<div class="about-couple-sub bg-white">';
                        ...
                        if( $hcode_block_facebook ):
                            $output .= '<a target="_blank" href="'.esc_url( $hcode_block_facebook_url ).'" class="black-text-link"><i class="fa fa-facebook extra-small-icon"></i></a>';
                        endif;
                        if( $hcode_block_twitter ):
                            $output .= '<a target="_blank" href="'.esc_url( $hcode_block_twitter_url ).'" class="black-text-link"><i class="fa fa-twitter extra-small-icon"></i></a>';
                        endif;
                        if( $hcode_block_googleplus ):
                            $output .= '<a target="_blank" href="'.esc_url( $hcode_block_googleplus_url ).'" class="black-text-link"><i class="fa fa-google-plus extra-small-icon"></i></a>';
                        endif;
                        if( $hcode_block_dribbble ):
                            $output .= '<a target="_blank" href="'.esc_url( $hcode_block_dribbble_url ).'" class="black-text-link"><i class="fa fa-dribbble extra-small-icon"></i></a>';
                        endif;
                        if( $hcode_block_youtube ):
                            $output .= '<a target="_blank" href="'.esc_url( $hcode_block_youtube_url ).'" class="black-text-link"><i class="fa fa-youtube extra-small-icon"></i></a>';
                        endif;
                        if( $hcode_block_linkedin ):
                            $output .= '<a target="_blank" href="'.esc_url( $hcode_block_linkedin_url ).'" class="black-text-link"><i class="fa fa-linkedin extra-small-icon"></i></a>';
                        endif;
                        if( $hcode_block_instagram ):
                            $output .= '<a target="_blank" href="'.esc_url( $hcode_block_instagram_url ).'" class="black-text-link"><i class="fa fa-instagram extra-small-icon"></i></a>';
                        endif;
                        if( $hcode_block_pinterest ):
                            $output .= '<a target="_blank" href="'.esc_url( $hcode_block_pinterest_url ).'" class="black-text-link"><i class="fa fa-pinterest-p extra-small-icon"></i></a>';
                        endif;
                        if( $hcode_block_github ):
                            $output .= '<a target="_blank" href="'.esc_url( $hcode_block_github_url ).'" class="black-text-link"><i class="fa fa-github extra-small-icon"></i></a>';
                        endif;
                        if( $hcode_block_website ):
                            $output .= '<a target="_blank" href="'.esc_url( $hcode_block_website_url ).'" class="black-text-link"><i class="fa fa-external-link extra-small-icon"></i></a>';
                        endif;
                            ...
                            if( $hcode_block_hover_icon2 || $hcode_block_hover_title2 || $hcode_block_hover_subtitle2 ):
                                $output .= '<div class="popular-destinations-highlight-sub">';
                                    if( $hcode_block_hover_custom_icon == 1 && !empty( $hcode_block_hover_custom_icon_image ) ) :
                                        $output .= '<img src="'.wp_get_attachment_url( $hcode_block_hover_custom_icon_image ).'" alt="" class="icon-image medium-icon" />';
                            ...
                            if( $hcode_block_hover_icon2 || $hcode_block_hover_title2 || $hcode_block_hover_subtitle2 || ( $hcode_block_hover_custom_icon2 == 1 && !empty( $hcode_block_hover_custom_icon2_image ) ) ):
                                $output .= '<div class="popular-destinations-highlight-sub">';
                                    if( $hcode_block_hover_custom_icon2 == 1 && !empty( $hcode_block_hover_custom_icon2_image ) ) :
                                        $output .= '<img src="'.wp_get_attachment_url( $hcode_block_hover_custom_icon2_image ).'" alt="" class="icon-image medium-icon" />';
