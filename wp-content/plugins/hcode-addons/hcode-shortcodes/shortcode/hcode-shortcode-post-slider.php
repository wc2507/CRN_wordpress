                ...
                case "blog-slider-1" :
                        ...
                        $output .='<div class="post-details">';
                            ...
                            if( $hcode_show_author_name == 1 || $hcode_show_date == 1 ):
                                $output .='<span class="post-author light-gray-text2">';
                                    ...
                                    if( $hcode_show_date == 1 ):
                                        ...
                                        $output .= ( !empty( $hcode_show_author_name ) ? ' | ' : '' ).get_the_date($date_format, get_the_ID());
                                    endif;
                                $output .='</span>';
                            endif;
                        ...
                        $output .='<div class="blog-slider-con">';
                            $output .='<figure>';
                                ...
                                $output .='<figcaption>';
                                    ...
                                    if( $hcode_show_author_name == 1 || $hcode_show_date == 1 ):
                                        $output .='<span class="post-author light-gray-text">';
                                            if( $hcode_show_author_name == 1 ):
                                                $output .= esc_html__('Posted by ','hcode-addons').$author;
                                            endif;
                                            ...
                                            if( $hcode_show_date == 1 ):
                                                ...
                                                $output .= ( !empty( $hcode_show_author_name ) ? ' | ' : '' ) .get_the_date($date_format, get_the_ID()).'</span>';
                                            endif;
                                        $output .='</span>';
                                    endif;
