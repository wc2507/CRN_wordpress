...
vc_map( array(
  ...
  'params' => array(
    ...
    array(
      ...
      'dependency' => array( 'element' => 'hcode_video_type', 'value' => array('vimeo','youtube') ),
    ),
    array(
      'type' => 'hcode_custom_switch_option',
      'holder' => 'div',
...
vc_map( array(
    ...
    'params' => array(
      ...
      array(
          'type' => 'hcode_custom_switch_option',
          'heading' => __('Show Content', 'hcode-addons'),
          'param_name' => 'hcode_show_content',
          'value' => array(__('No', 'hcode-addons') => '0', 
                           __('Yes', 'hcode-addons') => '1'
                          ),
          'description' => __( 'Select content to show blog content', 'hcode-addons' ),
          'std'         => '1',
...
vc_map( array(
      ...
      'params' => array(
        ...
        array(
          ...
          'dependency' => array( 'element' => 'hcode_block_premade_style', 'value' => array('block-2', 'block-20', 'block-13', 'block-24', 'block-30', 'block-31', 'block-32') ),
        ),
        array(
          'type' => 'attach_image',
          'heading' => __('Custom Icon Image', 'hcode-addons'),
