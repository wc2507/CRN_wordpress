    ...
    <div class="container-fluid bg-dark-gray footer-bottom">
        <div class="container">
            <div class="row margin-three">
                ...
                ?>
                    <!-- copyright -->
                    <div class="col-md-<?php echo $column_size ?> col-sm-<?php echo $column_size ?> col-xs-12 copyright text-left letter-spacing-1 xs-text-center xs-margin-bottom-one light-gray-text2">
