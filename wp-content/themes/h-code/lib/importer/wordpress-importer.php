...
<?php
	...
	function process_attachment( $post, $url ) {
		...
		$original_url = $url;
		$url_exists = $url;
		$url = str_replace("http://wpdemos.themezaa.com/h-code", HCODE_THEME_IMPORTER_SAMPLEDATA_URI , $url );
		$url_exists = str_replace("http://wpdemos.themezaa.com/h-code", HCODE_THEME_IMPORTER_SAMPLEDATA , $url_exists );
